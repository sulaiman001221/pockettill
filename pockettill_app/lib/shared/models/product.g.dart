...
const ProductSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'catalogueSyncedImageUrl': PropertySchema(
      id: 2,
      name: r'catalogueSyncedImageUrl',
      type: IsarType.string,
    ),
...
int _productEstimateSize(
  ...
  {
    final value = object.catalogueSyncedImageUrl;
    if (value != null) {
      bytesCount += 3 + value.length * 3;
    }
  }
...
void _productSerialize(
  ...
  writer.writeString(offsets[2], object.catalogueSyncedImageUrl);
...
Product _productDeserialize(
  ...
  object.catalogueSyncedImageUrl = reader.readStringOrNull(offsets[2]);
  object.category = reader.readStringOrNull(offsets[3]);
  object.costPrice = reader.readDoubleOrNull(offsets[4]);
...
extension ProductQueryFilter
  ...
  QueryBuilder<Product, Product, QAfterFilterCondition> cachedImagePathEqualTo(
    String? value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Product, Product, QAfterFilterCondition> cachedImagePathLessThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Product, Product, QAfterFilterCondition> cachedImagePathBetween(
    String? lower,
    String? upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Product, Product, QAfterFilterCondition> cachedImagePathEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Product, Product, QAfterFilterCondition> massEqualTo(
    String? value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Product, Product, QAfterFilterCondition> massGreaterThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Product, Product, QAfterFilterCondition> massLessThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Product, Product, QAfterFilterCondition> massBetween(
    String? lower,
    String? upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Product, Product, QAfterFilterCondition> massStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Product, Product, QAfterFilterCondition> massEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
...
extension ProductQuerySortBy on QueryBuilder<Product, Product, QSortBy> {
  ...
  QueryBuilder<Product, Product, QAfterSortBy> sortByCachedImagePath() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'cachedImagePath', Sort.asc);
    });
  }

  QueryBuilder<Product, Product, QAfterSortBy> sortByCachedImagePathDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'cachedImagePath', Sort.desc);
    });
  }

  QueryBuilder<Product, Product, QAfterSortBy> sortByCatalogueSyncedImageUrl() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'catalogueSyncedImageUrl', Sort.asc);
    });
  }
  ...
  QueryBuilder<Product, Product, QAfterSortBy> sortByMass() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'mass', Sort.asc);
    });
  }

  QueryBuilder<Product, Product, QAfterSortBy> sortByMassDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension ProductQuerySortThenBy
  ...
  QueryBuilder<Product, Product, QAfterSortBy> thenByCachedImagePath() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'cachedImagePath', Sort.asc);
    });
  }

  QueryBuilder<Product, Product, QAfterSortBy> thenByCachedImagePathDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'cachedImagePath', Sort.desc);
    });
  }

  QueryBuilder<Product, Product, QAfterSortBy> thenByCatalogueSyncedImageUrl() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'catalogueSyncedImageUrl', Sort.asc);
    });
  }
  ...
  QueryBuilder<Product, Product, QAfterSortBy> thenByMass() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'mass', Sort.asc);
    });
  }

  QueryBuilder<Product, Product, QAfterSortBy> thenByMassDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'mass', Sort.desc);
    });
  }
...
extension ProductQueryProperty
  ...
  QueryBuilder<Product, String?, QQueryOperations> cachedImagePathProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Product, String?, QQueryOperations> massProperty() {
    return QueryBuilder.apply(this, (query) {
